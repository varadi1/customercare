# CustomerCare Infrastructure

## Szolgáltatások

| Port | Szolgáltatás | Típus | LaunchAgent |
|------|-------------|-------|-------------|
| 8101 | CC backend | Docker | docker-compose.yml |
| 8102 | BGE v2-m3 reranker | LaunchAgent (MPS GPU) | com.openclaw.bge-reranker.plist |
...
|-------|----------|---------|
| com.openclaw.bge-reranker | RunAtLoad + KeepAlive | BGE reranker service |
...
| com.openclaw.cc-weekly-gap-report | Hetente H 06:00 | Knowledge gap riport |
